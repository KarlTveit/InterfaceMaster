...
if("TRUE" STREQUAL "TRUE")
  set(msf_updates_SOURCE_PREFIX /home/karlmt/catkin_ws/src/ethzasl_msf/msf_updates)
  set(msf_updates_DEVEL_PREFIX /home/karlmt/catkin_ws/devel)
  ...
  set(msf_updates_INSTALL_PREFIX /home/karlmt/catkin_ws/install)
...
if(NOT "/home/karlmt/catkin_ws/devel/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_updates/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_timing/include;/opt/ros/melodic/include;/opt/ros/melodic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(msf_updates_INCLUDE_DIRS "")
  set(_include_dirs "/home/karlmt/catkin_ws/devel/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_updates/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_timing/include;/opt/ros/melodic/include;/opt/ros/melodic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'msf_updates' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'msf_updates' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/karlmt/catkin_ws/src/ethzasl_msf/msf_updates/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT msf_updates_NUM_DUMMY_TARGETS)
      set(msf_updates_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::msf_updates::wrapped-linker-option${msf_updates_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR msf_updates_NUM_DUMMY_TARGETS "${msf_updates_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::msf_updates::wrapped-linker-option${msf_updates_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND msf_updates_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${msf_updates_dep}_FOUND)
      find_package(${msf_updates_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${msf_updates_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
