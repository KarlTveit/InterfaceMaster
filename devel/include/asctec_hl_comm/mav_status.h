...
bool operator==(const ::asctec_hl_comm::mav_status_<ContainerAllocator1> & lhs, const ::asctec_hl_comm::mav_status_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.battery_voltage == rhs.battery_voltage &&
    lhs.flight_mode_ll == rhs.flight_mode_ll &&
    lhs.state_estimation == rhs.state_estimation &&
    lhs.position_control == rhs.position_control &&
    lhs.serial_interface_enabled == rhs.serial_interface_enabled &&
    lhs.serial_interface_active == rhs.serial_interface_active &&
    ...
    lhs.debug1 == rhs.debug1 &&
    lhs.debug2 == rhs.debug2 &&
    lhs.have_SSDK_parameters == rhs.have_SSDK_parameters &&
    lhs.tx_packets == rhs.tx_packets &&
    lhs.tx_packets_good == rhs.tx_packets_good &&
    lhs.rx_packets == rhs.rx_packets &&
    lhs.rx_packets_good == rhs.rx_packets_good &&
    lhs.timesync_offset == rhs.timesync_offset;
}
