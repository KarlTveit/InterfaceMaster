...
bool operator==(const ::ssf_updates::PositionWithCovarianceStamped_<ContainerAllocator1> & lhs, const ::ssf_updates::PositionWithCovarianceStamped_<ContainerAllocator2> & rhs)
{
