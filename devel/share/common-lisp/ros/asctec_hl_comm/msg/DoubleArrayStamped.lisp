...
(cl:defmethod cl:initialize-instance :after ((m <DoubleArrayStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoubleArrayStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asctec_hl_comm-msg:<DoubleArrayStamped> is deprecated: use asctec_hl_comm-msg:DoubleArrayStamped instead.")))
...
(cl:defmethod data-val ((m <DoubleArrayStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asctec_hl_comm-msg:data-val is deprecated.  Use asctec_hl_comm-msg:data instead.")
  (data m))
