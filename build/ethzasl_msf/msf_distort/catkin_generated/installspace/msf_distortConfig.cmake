...
if("FALSE" STREQUAL "TRUE")
  set(msf_distort_SOURCE_PREFIX /home/karlmt/catkin_ws/src/ethzasl_msf/msf_distort)
  set(msf_distort_DEVEL_PREFIX /home/karlmt/catkin_ws/devel)
  ...
  set(msf_distort_INSTALL_PREFIX /home/karlmt/catkin_ws/install)
...
if(NOT "include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_timing/include;/home/karlmt/catkin_ws/src/image_common/image_transport/include;/home/karlmt/catkin_ws/src/vision_opencv/image_geometry/include;/opt/ros/melodic/include;/opt/ros/melodic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include/eigen3;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(msf_distort_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_timing/include;/home/karlmt/catkin_ws/src/image_common/image_transport/include;/home/karlmt/catkin_ws/src/vision_opencv/image_geometry/include;/opt/ros/melodic/include;/opt/ros/melodic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include/eigen3;/usr/include;/usr/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'msf_distort' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT msf_distort_NUM_DUMMY_TARGETS)
      set(msf_distort_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::msf_distort::wrapped-linker-option${msf_distort_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR msf_distort_NUM_DUMMY_TARGETS "${msf_distort_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::msf_distort::wrapped-linker-option${msf_distort_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND msf_distort_LIBRARIES "${interface_target_name}")
