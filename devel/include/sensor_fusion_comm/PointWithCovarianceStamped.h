...
bool operator==(const ::sensor_fusion_comm::PointWithCovarianceStamped_<ContainerAllocator1> & lhs, const ::sensor_fusion_comm::PointWithCovarianceStamped_<ContainerAllocator2> & rhs)
{
