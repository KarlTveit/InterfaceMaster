...
if("TRUE" STREQUAL "TRUE")
  set(msf_core_SOURCE_PREFIX /home/karlmt/catkin_ws/src/ethzasl_msf/msf_core)
  set(msf_core_DEVEL_PREFIX /home/karlmt/catkin_ws/devel)
  set(msf_core_INSTALL_PREFIX "")
  set(msf_core_PREFIX ${msf_core_DEVEL_PREFIX})
else()
  set(msf_core_SOURCE_PREFIX "")
  set(msf_core_DEVEL_PREFIX "")
  set(msf_core_INSTALL_PREFIX /home/karlmt/catkin_ws/install)
...
if(NOT "/home/karlmt/catkin_ws/devel/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/include;/usr/include/eigen3 " STREQUAL " ")
  set(msf_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/karlmt/catkin_ws/devel/include;/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'msf_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT msf_core_NUM_DUMMY_TARGETS)
      set(msf_core_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::msf_core::wrapped-linker-option${msf_core_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR msf_core_NUM_DUMMY_TARGETS "${msf_core_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::msf_core::wrapped-linker-option${msf_core_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND msf_core_LIBRARIES "${interface_target_name}")
...
set(pkg_cfg_extras "/home/karlmt/catkin_ws/src/ethzasl_msf/msf_core/cmake/export_flags.cmake")
