...
"""autogenerated by genpy from asctec_hl_comm/WaypointActionFeedback.msg. Do not edit."""
import sys
...
class WaypointActionFeedback(genpy.Message):
  _md5sum = "fe5606caf5ebc53ae46fa241a4af9304"
  _type = "asctec_hl_comm/WaypointActionFeedback"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','asctec_hl_comm/WaypointFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WaypointActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = asctec_hl_comm.msg.WaypointFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = asctec_hl_comm.msg.WaypointFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4f().pack(_x.feedback.current_pos.x, _x.feedback.current_pos.y, _x.feedback.current_pos.z, _x.feedback.current_yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.current_pos.x, _x.feedback.current_pos.y, _x.feedback.current_pos.z, _x.feedback.current_yaw,) = _get_struct_4f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.feedback.status = str[start:end].decode('utf-8')
      else:
