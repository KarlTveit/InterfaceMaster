...
class WaypointActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new WaypointFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = WaypointFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new WaypointActionFeedback(null);
    ...
    data.feedback = WaypointFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += WaypointFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new WaypointActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = WaypointFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new WaypointFeedback()
    }
...
module.exports = WaypointActionFeedback;
