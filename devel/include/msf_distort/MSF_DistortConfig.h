  ...
  public:
    ...
    public:
      ParamDescription(std::string a_name, std::string a_type, uint32_t a_level,
          std::string a_description, std::string a_edit_method, T MSF_DistortConfig::* a_f) :
  ...
  public:
    ...
    void setParams(MSF_DistortConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("publish_position"==(*_i)->name){publish_position = boost::any_cast<bool>(val);}
      }
    }
...
//#line 42 "/home/karlmt/catkin_ws/src/ethzasl_msf/msf_distort/cfg/MSF_Distort.cfg"
