...
"""autogenerated by genpy from asctec_hl_comm/WaypointActionResult.msg. Do not edit."""
import sys
...
class WaypointActionResult(genpy.Message):
  _md5sum = "98dea99f8d3ca1caab80159128839c26"
  _type = "asctec_hl_comm/WaypointActionResult"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','asctec_hl_comm/WaypointResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WaypointActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = asctec_hl_comm.msg.WaypointResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = asctec_hl_comm.msg.WaypointResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4f().pack(_x.result.result_pos.x, _x.result.result_pos.y, _x.result.result_pos.z, _x.result.result_yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.result_pos.x, _x.result.result_pos.y, _x.result.result_pos.z, _x.result.result_yaw,) = _get_struct_4f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
